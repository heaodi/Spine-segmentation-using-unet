...
io.imsave("D:/pythoncode/segment/data/spine/1_predict.png", dst)


# cv2.imshow('image', img1[:, :, 5])
# cv2.waitKey(0)

scipy.misc.imsave("D:/pythoncode/segment/data/spine/2_predict.png", img1[:, :, 5])
...
train_image1 = io.imread("D:/pythoncode/segment/data/spine/test/predict1/3_predict.png")
